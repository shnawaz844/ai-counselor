...
** Polytechnic:** Diploma in Engineering(various specializations like Civil, Mechanical, Electrical).`;
    ...
    switch (counselorId) {
      case '1':
        selectedKb = engKb + invertisKb + srmsKb + ssvgiKb;
        break;
      case '2':
        selectedKb = medKb + srmsKb + ssvgiKb;
        break;
      case '3':
        selectedKb = comKb + invertisKb + srmsKb + ssvgiKb;
        break;
      case '4':
        selectedKb = artsKb + invertisKb;
        break;
      case '5':
        selectedKb = csKb + invertisKb + srmsKb + ssvgiKb;
        break;
      case '6':
        selectedKb = entKb + invertisKb + srmsKb + ssvgiKb;
        break;
      default:
        selectedKb = engKb + medKb + comKb;
    }

    const systemPrompt = `You are a highly specialized ${specificRole}. Your ONLY job is to provide expert guidance in this specific field.Do NOT ask the user which field they are interested in, because you already know they came to you for ${specificRole} advice! Respond professionally, encouragingly, and natively adapt to the user's language (English, Hindi, or Hinglish). Keep responses concise.
